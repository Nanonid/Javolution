...
public class Comparators {
    ...
    public static final FullComparator<Object> STANDARD = new StandardComparatorImpl<Object>();
    ...
    @Parallelizable
    @RealTime(limit = LINEAR)
    public static final FullComparator<CharSequence> LEXICAL = new LexicalComparatorImpl();
    ...
    @Parallelizable
    @RealTime(limit = LINEAR)
    public static final FullComparator<CharSequence> LEXICAL_CASE_INSENSITIVE = new LexicalCaseInsensitiveComparatorImpl();
    ...
    @Parallelizable
    @RealTime(limit = LINEAR)
    public static final FullComparator<CharSequence> LEXICAL_FAST = new LexicalFastComparatorImpl();
